...
(function($, window, document, undefined) {
    ...
    function readyDom(iObj) {
        var holder = iObj.holder,
            ...
            html = '<div class="zepto-sliderlock"><div class="zepto-sliderlock-bar"></div><span class="masked" style="position:absolute;line-height:48px;font-size:16px;right:10px;top:0;width:155px;">滑动获取房间密钥&nbsp;&nbsp;》</span></div>';
        ...
        holder.html(html).children('.zepto-sliderlock').css({
            ...
            'height':'44px',
            'width':'44px',
            'background-color': (secondaryColor || "#ffffff"),
            'border-radius': (radius || 0) + 'px',
            'margin': (barMargin || 0) + 'px',
            'position': 'absolute',
            'background-image':'url(./images/icon-key-105x104.png)',
